...
//    @Before("com.learningByDoing.learn_spring_aop.aopexample.aspects.CommonPointcutConfig.businessAndDataPackageConfig()")
    @Before("com.learningByDoing.learn_spring_aop.aopexample.aspects.CommonPointcutConfig.allPackageConfigUsingBean()")
...
//            logger.info("Before Aspect -  Method is called - {}", joinPoint); // WHAT to do
    ...
    @After("com.learningByDoing.learn_spring_aop.aopexample.aspects.CommonPointcutConfig.businessAndDataPackageConfig()") // WHEN to do
...
//      logger.info("After Aspect -  Method is called - {}", joinPoint); // WHAT to do
    ...
    @AfterThrowing(pointcut = "com.learningByDoing.learn_spring_aop.aopexample.aspects.CommonPointcutConfig.businessAndDataPackageConfig()",
...
//      logger.info("AfterThrowing Aspect -  {} - has thrown exception", joinPoint); // WHAT to do
    ...
    @AfterReturning(pointcut = "com.learningByDoing.learn_spring_aop.aopexample.aspects.CommonPointcutConfig.dataPackageConfig()",
